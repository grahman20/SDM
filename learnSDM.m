function [svm_model, kernel_param, training_features] = learnSDM(pos_features, neg_features, ul_features, param, options)
...
for i = 1:MAX_ITER
    ...
    %calculate MMD (M) and Manifold (L) and integrate with SVM kernel
    if i>hasLabel
